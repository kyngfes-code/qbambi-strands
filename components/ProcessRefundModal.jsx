  ...
  */
  ...
  return (
    ...
    "
          ...
          {/* Warning */}
          {!isAppointment && Number(approvedAmount) < requestedAmount ? (
            ...
            {isAppointment ? (
              <>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto px-5 py-3 rounded-xl bg-red-600 text-white hover:bg-red-700 disabled:opacity-50"
                >
